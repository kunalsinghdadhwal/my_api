...
export const dashboard = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(dashboardStatsSchema, "Dashboard statistics overview"),
    },
});
...
export const productivity = createRoute({
    ...
    responses: {
        [HttpStatusCodes.OK]: jsonContent(productivityStatsSchema, "Productivity statistics over time"),
    },
});
