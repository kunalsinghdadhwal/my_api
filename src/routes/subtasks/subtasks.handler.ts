...
import type { CreateRoute, GetOneRoute, ListRoute, PatchRoute, RemoveRoute, ReorderRoute, ToggleRoute } from "./subtasks.routes";

// Helper to check if parent task exists
async function taskExists(db: ReturnType<typeof createDb>["db"], taskId: number) {
